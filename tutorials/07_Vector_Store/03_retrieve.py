...
vector_store = InMemoryVectorStore(embedding=DashScopeEmbeddings(model="text-embedding-v4", dashscope_api_key=os.getenv("QWEN_API_KEY")))
...
vector_store.add_texts(["减肥就是要运动，控制饮食", "在减脂期吃东西很重要，清淡少油少盐控制卡路里摄入并运动起来", "游泳是很好的运动", "跑步是很好的运动"])
